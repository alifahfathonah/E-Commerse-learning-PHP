          ...
          <div class="products_box">
           ...
           $get_products="select * from products where product_id='$product_id' ";
              ...
              while($row_products=mysqli_fetch_array($run_products)){
                  ...
                  <h3>$pro_title</h3>
                  <img src='admin_area/product_images/$pro_image1' width='220' height='210'/>
                  <img src='admin_area/product_images/$pro_image2' width='250' height='260'/>
                  <img src='admin_area/product_images/$pro_image3' width='250' height='260'/>
                  <br>
                   <p><b>price $pro_price</b></p>
                   <p><b>price $pro_desc</b></p>
