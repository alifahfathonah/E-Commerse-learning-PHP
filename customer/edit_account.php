    ...
    <table width="750" align="center">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td> <input type="file" name="c_image" size="60"><img src="customer_photos/<?php echo $image; ?>" alt="" width="80" height="80"></td>
...
if(isset($_POST['update_account'])){
    ...
    if($run_c){
        echo "<script>alert('Your account hasbeen updates!')</script>";
